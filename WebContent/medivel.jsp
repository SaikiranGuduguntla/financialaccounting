    ...
    <div class="container-fluid">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="medivel.jsp">Travel & Medical</a></li>
          </ul>
        </div>
        
        
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">TRAVEL & MEDICAL</h1>
			...
			try
				{
					...
					String sql = "select * from medivel";
			...
			try
				{
					...
					String sql1 = "select * from conmedivel";
				...
				while(rs1.next())
					...
					<tr>
 					...
 					<td><%=rs1.getString("fname")+rs1.getString("lname") %></td>
      				<td><%=rs1.getString("travel") %></td>
      				<td><%=rs1.getString("medical") %></td>
